    ...
    <section id="servicios" className="section-padding" ref={sectionRef}>
      <div className="container mx-auto">
        ...
        <div className="mt-16 text-center animate-on-scroll opacity-0">
          <Button
            className="rounded-full px-6 py-4 md:px-12 md:py-8 bg-gradient-to-r from-green-500 to-green-600 text-white hover:from-green-600 hover:to-green-700 font-bold text-base md:text-xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center gap-2 md:gap-4 border-2 border-green-400 relative overflow-hidden group w-full sm:w-auto"
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16" className="animate-pulse md:w-8 md:h-8">
            ...
            <span className="relative z-10 tracking-wide text-sm md:text-base lg:text-xl">Solicitar presupuesto sin cargo</span>
          </Button>
        </div>
      </div>
    </section>
